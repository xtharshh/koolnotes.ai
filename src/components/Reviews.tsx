...
export default function AboutAndReviews() {
  ...
  return (
    <div ref={scrollRef} data-scroll-container id="aboutus" className="min-h-screen bg-white dark:bg-black text-black dark:text-white w-full py-12 px-4 md:px-6 bg-background">
      <section className="mb-20">
        <div className="container mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-4 items-center">
            <div className="space-y-6 text-center vlg:pl-28" data-scroll-section>
      ...
      <section id='reviews' className="container mx-auto mb-20 font-newLuck">
        ...
        <div className="relative max-w-4xl mx-auto" data-scroll-section>
